...
#%%
def create_lspace_network(dim):
    net = nx.grid_graph(dim)
    return net
...
if __name__ == "__main__":
    ...
    dims = [(2,5),(3,5),(5,5),(5,10),(10,20),(20,30)]
    number_of_nodes = [n*m for n,m in dims]
    measures_lspace = []
    measures_pspace = []
    measures_cspace = []
    for dim,number_of_node in zip(dims,number_of_nodes):
        net_l = create_lspace_network(dim)
